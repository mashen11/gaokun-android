...
**当前阶段：Stage 6 收尾 —— 相机与产品化。v0.6.1-alpha 已发布（2026-09-14，构建戳 `1789364282`）：相机前后摄可用、闪光灯接进 HAL、camss 容忍缺失传感器、后摄固定为相机 0。手上在做的是画质（降噪/闪光过曝）、息屏 USB adb、触摸手感、Google 认证 —— 都在 `docs/TODO.md` 的「现在在做」表里。（每次开工时更新这一行）**
